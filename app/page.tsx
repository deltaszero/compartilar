...
const features = [
    {
        ...
        description: 'Crie e gerencie um plano de parentalidade completo para organizar as responsabilidades, rotinas e acordos importantes sobre seus filhos.',
        analyticsId: 'feature_parental_plan'
    },
    {
        id: 'organize',
        title: 'Organize',
        description: 'Mantenha todas as informações importantes dos seus filhos organizadas: documentos, saúde, educação e muito mais em um só lugar.',
        analyticsId: 'feature_organize'
    },
    {
        id: 'proteja',
        title: 'Proteja',
        description: 'Seus dados são protegidos com a mais alta segurança, permitindo o compartilhamento apenas com quem você autorizar.',
        analyticsId: 'feature_protect'
    },
    {
        id: 'despreocupe-se',
        title: 'Despreocupe-se',
        description: 'Nunca mais se preocupe com informações perdidas ou comunicação confusa. Tenha tudo ao seu alcance quando precisar.',
...
export default function Home() {
    ...
    useEffect(() => {
        ...
        const handleScroll = () => {
            const observe = (ref: React.RefObject<HTMLElement>, sectionId: string) => {
                ...
                setVisibleSections(prev => {
                    ...
                    if (isVisible && !prev.has(sectionId)) {
                        trackEvent(AnalyticsEventType.SECTION_VIEW, { section_id: sectionId });
    ...
    const handleFeatureClick = (featureId: string, analyticsId: string) => {
        trackEvent(AnalyticsEventType.FEATURE_CLICK, {
            ...
            feature_position: Array.from(features).findIndex(f => f.id === featureId)
        });
    };
    ...
    return (
        <section className="flex flex-col">
            ...
            <section className="hero bg-base-200" ref={heroRef}>
                <div className="hero-content flex-col lg:flex-row-reverse sm:py-24">
                    <Image
                        ...
                        priority
                        onLoad={() => trackEvent(AnalyticsEventType.PAGE_VIEW, {
            ...
            {/* FEATURES SECTION */}
            <div ref={featuresRef} className="flex flex-row bg-base-200 justify-center items-center text-center py-12 font-raleway font-bold text-4xl">
