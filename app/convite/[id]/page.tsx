  ...
  useEffect(() => {
    const fetchInvitation = async () => {
      try {
        ...
        const createdAt = invitationData.createdAt instanceof Date 
    ...
    return (
      <div className="max-w-md w-full p-6 bg-white rounded-xl shadow-xl">
        <div className="text-center mb-6">
          <h2 className="text-2xl font-bold mb-2">Convite para o CompartiLar</h2>
          <p className="text-sm text-gray-600">
            {invitation.inviterName} convidou você para uma conexão de {relationshipLabel}
          </p>
        </div>
        
        <div className="bg-gray-50 p-4 rounded-lg mb-6">
          <p className="italic text-gray-700">"{invitation.message}"</p>
        </div>
        
        <div className="mb-6">
          <h3 className="font-semibold mb-2">Sobre o CompartiLar</h3>
          <p className="text-sm text-gray-700">
            CompartiLar é uma plataforma que ajuda famílias a gerenciar a co-parentalidade e manter uma rede de apoio conectada.
          </p>
        </div>
    ...
    if (status === 'not-found') {
      return (
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-6">O convite que você está procurando não existe ou foi removido.</p>
      ...
      return (
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-6">Este convite expirou ou já foi utilizado.</p>
          <Link href="/" className="btn btn-primary">
            Ir para a página inicial
          </Link>
        </div>
