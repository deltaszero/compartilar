...
const AvatarSection = ({ photoURL }: { photoURL?: string }) => (
    <motion.div
        className="mask mask-squircle w-16 h-16 bg-gray-100 flex items-center justify-center"
...
const UserNavbar = ({ userData }: { userData: Partial<SignupFormData> }) => {
    ...
    return (
        <div className="flex flex-row items-center justify-between w-full p-4 bg-base-content text-white">
        ...
        return (
            <div className="flex flex-col items-start overflow-hidden">
                ...
                <motion.div
                    ...
                    pattern-dots pattern-green-200 pattern-bg-white pattern-size-2 pattern-opacity-20
                    "
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                    exit={{ opacity: 0 }}
