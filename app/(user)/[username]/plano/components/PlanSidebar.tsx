        ...
        <aside>
            <nav className="px-3">
                ...
                <div className="space-y-1 mt-4">
                    <h3 className="text-xs font-semibold uppercase px-3 mb-2 font-raleway">
                        Conteúdo do Plano
                    </h3>
                    ...
                    {planSections.map((section, index) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                >
                                    <div className="flex items-center justify-between w-full font-raleway font-bold">
                                        <div className="flex items-center">
                                            <span className={cn(
                                                "flex items-center justify-center w-5 h-5 mr-3 rounded-full",
                                                isCompleted
                                                    ? "text-white bg-blank"
                                                    : "bg-gray-100 border border-blank"
                                            )}>
                                                {isCompleted ? (
