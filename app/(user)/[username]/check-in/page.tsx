...
import { MapPin, Copy, ExternalLink, Save, Database, History } from 'lucide-react';
...
import { saveGeolocation } from './components/geolocation-service';
    ...
    return (
        <div className="container max-w-2xl mx-auto px-4 py-6 pb-20">
            <Card className="shadow-md">
                ...
                {userData && (
                    <CardFooter className="pt-0 px-6 justify-end">
                        <Button 
                            variant="ghost" 
                            size="sm"
                            className="text-muted-foreground"
                            // Link to history page (to be implemented)
                            onClick={() => toast({
                                title: "Em breve",
                                description: "O histórico de localizações estará disponível em breve.",
                            })}
                        >
