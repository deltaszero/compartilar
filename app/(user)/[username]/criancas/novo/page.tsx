...
import { ChevronLeft, Camera, Search, UserPlus, X, UserCog } from 'lucide-react';
    ...
    <div className="flex flex-col min-h-screen bg-gradient-to-b from-background to-muted/20">
            ...
            <div className="space-y-2 border rounded-md p-4">
              ...
              {selectedFriends.length > 0 ? (
                ...
                <p className="text-sm text-muted-foreground mt-2">
                  Adicione pessoas para compartilhar o acesso a esta criança. 
                  Você pode definir permissões de visualização ou edição.
                </p>
              )}
            </div>
          </CardContent>
      ...
      <Dialog open={showFriendSearch} onOpenChange={setShowFriendSearch}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            <DialogTitle>Buscar Pessoas</DialogTitle>
          </DialogHeader>
